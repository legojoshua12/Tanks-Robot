...
async def direct_message_commands(message, command):
    ...
    if command == 'help':
        ...
        emoji = '\U0001F52B'
        embedVar = discord.Embed(title="Rules", description=f"This is the rules on how to play tanks! {emoji}",
                                 color=embedColor)
...
async def public_commands(message, command):
    ...
    if command == 'help':
        ...
        waveEmoji = '\U0001F52B'
        embedVar = discord.Embed(title="Rules", description=f"This is the rules on how to play tanks! {waveEmoji}",
                                 color=embedColor)
        embedVar.add_field(name="1. You use actions to do things", value="Actions are the the core of the game, "
                                                                         "they can be used to move, shoot, or "
                                                                         "increase your tank's range.",
